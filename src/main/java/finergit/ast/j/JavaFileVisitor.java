...
import finergit.ast.j.token.AND;
import finergit.ast.j.token.ANNOTATION;
import finergit.ast.j.token.ANNOTATIONCOMMA;
import finergit.ast.j.token.ANNOTATIONTYPEMEMBERDECLARATIONSEMICOLON;
import finergit.ast.j.token.ARRAYINITIALIZERCOMMA;
import finergit.ast.j.token.ASSERT;
import finergit.ast.j.token.ASSERTSTATEMENTSEMICOLON;
import finergit.ast.j.token.ASSIGN;
import finergit.ast.j.token.BLOCKCOMMENT;
import finergit.ast.j.token.BREAK;
import finergit.ast.j.token.BREAKSTATEMENTSEMICOLON;
import finergit.ast.j.token.BooleanLiteralFactory;
import finergit.ast.j.token.CASE;
import finergit.ast.j.token.CATCH;
import finergit.ast.j.token.CHARLITERAL;
import finergit.ast.j.token.CLASS;
import finergit.ast.j.token.CLASSINSTANCECREATIONCOMMA;
import finergit.ast.j.token.CLASSNAME;
import finergit.ast.j.token.COLON;
import finergit.ast.j.token.CONSTRUCTORINVOCATIONCOMMA;
import finergit.ast.j.token.CONSTRUCTORINVOCATIONSEMICOLON;
import finergit.ast.j.token.CONTINUE;
import finergit.ast.j.token.CONTINUESTATEMENTSEMICOLON;
import finergit.ast.j.token.DECLAREDMETHODNAME;
import finergit.ast.j.token.DEFAULT;
import finergit.ast.j.token.DIMENSIONCOMMA;
import finergit.ast.j.token.DO;
import finergit.ast.j.token.DOSTATEMENTSEMICOLON;
import finergit.ast.j.token.DOT;
import finergit.ast.j.token.ELSE;
import finergit.ast.j.token.EMPTYSTATEMENTSEMICOLON;
import finergit.ast.j.token.ENUM;
import finergit.ast.j.token.ENUMCOMMA;
import finergit.ast.j.token.EXPRESSIONSTATEMENTSEMICOLON;
import finergit.ast.j.token.EXTENDS;
import finergit.ast.j.token.FIELDDECLARATIONCOMMA;
import finergit.ast.j.token.FIELDDECLARATIONSEMICOLON;
import finergit.ast.j.token.FINALLY;
import finergit.ast.j.token.FOR;
import finergit.ast.j.token.FORCONDITIONSEMICOLON;
import finergit.ast.j.token.FORINITIALIZERCOMMA;
import finergit.ast.j.token.FORINITIALIZERSEMICOLON;
import finergit.ast.j.token.FORUPDATERCOMMA;
import finergit.ast.j.token.FinerJavaClassToken;
import finergit.ast.j.token.FinerJavaFieldToken;
import finergit.ast.j.token.FinerJavaMethodToken;
import finergit.ast.j.token.GREAT;
import finergit.ast.j.token.IF;
import finergit.ast.j.token.IMPLEMENTS;
import finergit.ast.j.token.IMPORT;
import finergit.ast.j.token.IMPORTNAME;
import finergit.ast.j.token.INSTANCEOF;
import finergit.ast.j.token.INVOKEDMETHODNAME;
import finergit.ast.j.token.JAVADOCCOMMENT;
import finergit.ast.j.token.JavaToken;
import finergit.ast.j.token.LABELNAME;
import finergit.ast.j.token.LAMBDAEXPRESSIONCOMMA;
import finergit.ast.j.token.LEFTANNOTATIONBRACKET;
import finergit.ast.j.token.LEFTANNOTATIONPAREN;
import finergit.ast.j.token.LEFTANONYMOUSCLASSBRACKET;
import finergit.ast.j.token.LEFTARRAYINITIALIZERBRACKET;
import finergit.ast.j.token.LEFTCASTPAREN;
import finergit.ast.j.token.LEFTCATCHCLAUSEBRACKET;
import finergit.ast.j.token.LEFTCATCHCLAUSEPAREN;
import finergit.ast.j.token.LEFTCLASSBRACKET;
import finergit.ast.j.token.LEFTCLASSINSTANCECREATIONPAREN;
import finergit.ast.j.token.LEFTCONSTRUCTORINVOCATIONPAREN;
import finergit.ast.j.token.LEFTDOBRACKET;
import finergit.ast.j.token.LEFTDOPAREN;
import finergit.ast.j.token.LEFTENHANCEDFORBRACKET;
import finergit.ast.j.token.LEFTENHANCEDFORPAREN;
import finergit.ast.j.token.LEFTENUMPAREN;
import finergit.ast.j.token.LEFTFORBRACKET;
import finergit.ast.j.token.LEFTFORPAREN;
import finergit.ast.j.token.LEFTIFBRACKET;
import finergit.ast.j.token.LEFTIFPAREN;
import finergit.ast.j.token.LEFTINITIALIZERBRACKET;
import finergit.ast.j.token.LEFTLAMBDABRACKET;
import finergit.ast.j.token.LEFTLAMBDAEXPRESSIONPAREN;
import finergit.ast.j.token.LEFTMETHODBRACKET;
import finergit.ast.j.token.LEFTMETHODINVOCATIONPAREN;
import finergit.ast.j.token.LEFTMETHODPAREN;
import finergit.ast.j.token.LEFTPARENTHESIZEDEXPRESSIONPAREN;
import finergit.ast.j.token.LEFTSIMPLEBLOCKBRACKET;
import finergit.ast.j.token.LEFTSQUAREBRACKET;
import finergit.ast.j.token.LEFTSUPERCONSTRUCTORINVOCATIONPAREN;
import finergit.ast.j.token.LEFTSWITCHBRACKET;
import finergit.ast.j.token.LEFTSWITCHPAREN;
import finergit.ast.j.token.LEFTSYNCHRONIZEDBRACKET;
import finergit.ast.j.token.LEFTSYNCHRONIZEDPAREN;
import finergit.ast.j.token.LEFTTRYBRACKET;
import finergit.ast.j.token.LEFTTRYPAREN;
import finergit.ast.j.token.LEFTWHILEBRACKET;
import finergit.ast.j.token.LEFTWHILEPAREN;
import finergit.ast.j.token.LESS;
import finergit.ast.j.token.LINECOMMENT;
import finergit.ast.j.token.LineToken;
import finergit.ast.j.token.METHODDECLARAIONPARAMETERCOMMA;
import finergit.ast.j.token.METHODDECLARATIONSEMICOLON;
import finergit.ast.j.token.METHODDECLARATIONTHROWSCOMMA;
import finergit.ast.j.token.METHODINVOCATIONCOMMA;
import finergit.ast.j.token.METHODREFERENCE;
import finergit.ast.j.token.ModifierFactory;
import finergit.ast.j.token.NEW;
import finergit.ast.j.token.NULL;
import finergit.ast.j.token.NUMBERLITERAL;
import finergit.ast.j.token.OR;
import finergit.ast.j.token.OperatorFactory;
import finergit.ast.j.token.PACKAGE;
import finergit.ast.j.token.PACKAGENAME;
import finergit.ast.j.token.PARAMETERIZEDTYPECOMMA;
import finergit.ast.j.token.PrimitiveTypeFactory;
import finergit.ast.j.token.QUESTION;
import finergit.ast.j.token.RETURN;
import finergit.ast.j.token.RETURNSTATEMENTSEMICOLON;
import finergit.ast.j.token.RIGHTANNOTATIONBRACKET;
import finergit.ast.j.token.RIGHTANNOTATIONPAREN;
import finergit.ast.j.token.RIGHTANONYMOUSCLASSBRACKET;
import finergit.ast.j.token.RIGHTARRAYINITIALIZERBRACKET;
import finergit.ast.j.token.RIGHTARROW;
import finergit.ast.j.token.RIGHTCASTPAREN;
import finergit.ast.j.token.RIGHTCATCHCLAUSEBRACKET;
import finergit.ast.j.token.RIGHTCATCHCLAUSEPAREN;
import finergit.ast.j.token.RIGHTCLASSBRACKET;
import finergit.ast.j.token.RIGHTCLASSINSTANCECREATIONPAREN;
import finergit.ast.j.token.RIGHTCONSTRUCTORINVOCATIONPAREN;
import finergit.ast.j.token.RIGHTDOBRACKET;
import finergit.ast.j.token.RIGHTDOPAREN;
import finergit.ast.j.token.RIGHTENHANCEDFORBRACKET;
import finergit.ast.j.token.RIGHTENHANCEDFORPAREN;
import finergit.ast.j.token.RIGHTENUMPAREN;
import finergit.ast.j.token.RIGHTFORBRACKET;
import finergit.ast.j.token.RIGHTFORPAREN;
import finergit.ast.j.token.RIGHTIFBRACKET;
import finergit.ast.j.token.RIGHTIFPAREN;
import finergit.ast.j.token.RIGHTINITIALIZERBRACKET;
import finergit.ast.j.token.RIGHTLAMBDABRACKET;
import finergit.ast.j.token.RIGHTLAMBDAEXPRESSIONPAREN;
import finergit.ast.j.token.RIGHTMETHODBRACKET;
import finergit.ast.j.token.RIGHTMETHODINVOCATIONPAREN;
import finergit.ast.j.token.RIGHTMETHODPAREN;
import finergit.ast.j.token.RIGHTPARENTHESIZEDEXPRESSIONPAREN;
import finergit.ast.j.token.RIGHTSIMPLEBLOCKBRACKET;
import finergit.ast.j.token.RIGHTSQUAREBRACKET;
import finergit.ast.j.token.RIGHTSUPERCONSTRUCTORINVOCATIONPAREN;
import finergit.ast.j.token.RIGHTSWITCHBRACKET;
import finergit.ast.j.token.RIGHTSWITCHPAREN;
import finergit.ast.j.token.RIGHTSYNCHRONIZEDBRACKET;
import finergit.ast.j.token.RIGHTSYNCHRONIZEDPAREN;
import finergit.ast.j.token.RIGHTTRYBRACKET;
import finergit.ast.j.token.RIGHTTRYPAREN;
import finergit.ast.j.token.RIGHTWHILEBRACKET;
import finergit.ast.j.token.RIGHTWHILEPAREN;
import finergit.ast.j.token.STATIC;
import finergit.ast.j.token.STRINGLITERAL;
import finergit.ast.j.token.SUPER;
import finergit.ast.j.token.SUPERCONSTRUCTORINVOCATIONCOMMA;
import finergit.ast.j.token.SUPERCONSTRUCTORINVOCATIONSEMICOLON;
import finergit.ast.j.token.SWITCH;
import finergit.ast.j.token.SWITCHCASEARROW;
import finergit.ast.j.token.SWITCHCASECOMMA;
import finergit.ast.j.token.SYNCHRONIZED;
import finergit.ast.j.token.THIS;
import finergit.ast.j.token.THROW;
import finergit.ast.j.token.THROWS;
import finergit.ast.j.token.THROWSTATEMENTSEMICOLON;
import finergit.ast.j.token.TRY;
import finergit.ast.j.token.TRYRESOURCESEMICOLON;
import finergit.ast.j.token.TYPEDECLARATIONCOMMA;
import finergit.ast.j.token.TYPENAME;
import finergit.ast.j.token.TYPEPARAMETERNAME;
import finergit.ast.j.token.VARIABLEDECLARATIONCOMMA;
import finergit.ast.j.token.VARIABLEDECLARATIONSTATEMENTSEMICOLON;
import finergit.ast.j.token.VARIABLENAME;
import finergit.ast.j.token.VariableArity;
import finergit.ast.j.token.WHILE;
import finergit.ast.j.token.YIELD;
import finergit.ast.j.token.YIELDSTATEMENTSEMICOLON;
...
public class JavaFileVisitor extends ASTVisitor {
  ...
  public List<FinerModule> getFinerJavaModules() {
  ...
  public boolean visit(final EnumDeclaration node) {
    ...
    if (0 == this.classNestLevel) {
      final FinerModule outerModule = this.moduleStack.peek();
  ...
  public boolean visit(final FieldDeclaration node) {
    ...
    if (1 == this.classNestLevel) {
      final FinerModule dummyField = this.moduleStack.pop();
      final FinerModule outerModule = this.moduleStack.peek();
  ...
  public boolean visit(final MethodDeclaration node) {
    ...
    if (1 == this.classNestLevel) {
      final FinerModule dummyMethod = this.moduleStack.pop();
      final FinerModule outerModule = this.moduleStack.peek();
  ...
  private void addToPeekModule(final JavaToken... tokens) {
    final FinerModule peekModule = this.moduleStack.peek();
    Stream.of(tokens)
